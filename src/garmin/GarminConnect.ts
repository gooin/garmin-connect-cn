...
export default class GarminConnect {
    ...
    async getRacePredictionsMonthly(
        ...
        try {
            ...
            return this.client.get<RacePredictionMonthly[]>(
                ...
                {
                    params: {
                        fromCalendarDate: toGarminDateString(fromCalendarDate),
    ...
    async getLatestLactateThreshold(): Promise<LatestLactateThresholdEntry[]> {
        try {
    ...
    async getRunningLactateThreshold(
        ...
        const combinedByMonth = new Map<string, RunningLactateThresholdEntry>();
